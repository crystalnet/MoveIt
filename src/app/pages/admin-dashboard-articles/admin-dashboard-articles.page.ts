...
export class AdminDashboardArticlesPage implements OnInit {
    ...
    constructor(private storage: AngularFireStorage, private toastController: ToastController,
                private database: AngularFirestore, private db: AngularFireDatabase,
                private informationService: InformationService, public popoverController: PopoverController) {
